...
export class AuthShellComponent {
    ...
    subtitle = "";
    mark = "S";
    static ɵfac = function AuthShellComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || AuthShellComponent)(); };
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: AuthShellComponent, selectors: [["auth-shell"]], inputs: { title: "title", subtitle: "subtitle", mark: "mark" }, standalone: true, features: [i0.ɵɵStandaloneFeature], ngContentSelectors: _c0, decls: 14, vars: 3, consts: [[1, "min-h-screen", "flex", "items-center", "justify-center", "bg-gradient-to-br", "from-[#9b6dff]", "via-[#6e72ff]", "to-[#ffb199]", "p-4", "sm:p-8"], [1, "w-full", "max-w-[1000px]", "bg-white", "rounded-[40px]", "shadow-2xl", "flex", "flex-col", "md:flex-row", "overflow-hidden", "min-h-[600px]"], [1, "w-full", "md:w-[45%]", "p-8", "sm:p-12", "flex", "flex-col", "justify-center"], [1, "mb-8"], [1, "w-12", "h-12", "bg-[#7c3aed]", "rounded-xl", "flex", "items-center", "justify-center", "mb-6", "text-white", "text-2xl", "font-bold"], [1, "text-3xl", "font-bold", "text-gray-800", "mb-2"], [1, "text-gray-400", "font-medium"], [1, "hidden", "md:flex", "flex-1", "bg-gray-50", "items-center", "justify-center", "p-12", "border-l", "border-gray-50"], [1, "w-full", "max-w-sm", "aspect-square", "rounded-[40px]", "bg-gradient-to-br", "from-purple-100", "via-white", "to-orange-100", "flex", "items-center", "justify-center", "text-[#7c3aed]", "text-8xl", "font-black", "shadow-inner"]], template: function AuthShellComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵprojectionDef();
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(AuthShellComponent, [{
        type: Component,
        args: [{
                selector: "auth-shell",
                standalone: true,
                inputs: ["title", "subtitle", "mark"],
                template: `
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#9b6dff] via-[#6e72ff] to-[#ffb199] p-4 sm:p-8">
      <div class="w-full max-w-[1000px] bg-white rounded-[40px] shadow-2xl flex flex-col md:flex-row overflow-hidden min-h-[600px]">
        <div class="w-full md:w-[45%] p-8 sm:p-12 flex flex-col justify-center">
          <div class="mb-8">
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(AuthShellComponent, { className: "AuthShellComponent" }); })();
